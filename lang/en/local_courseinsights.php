...
$string['help_messages_note'] = 'Messages sent via "Send Message" in an intervention case go to the student\'s Moodle Messages inbox. Students must check their Messages inbox (the chat icon), not the Notifications bell.';
$string['help_note_heading'] = 'Important notes';
$string['help_step1_body'] = 'Go to Site Administration, Server, Scheduled tasks and find "Build Course Insights summary cache". Run it manually once to populate the initial snapshots, then confirm it is scheduled to run nightly. Until this task runs, course detail pages fall back to live queries and load slowly.';
$string['help_step1_heading'] = '1. Run the cache build task';
$string['help_step2_body'] = 'Go to Site Administration, Plugins, Local plugins, Course Insights. Set your risk inactivity threshold, choose how many months of trend data to display, and optionally set a brand accent colour. Enable "Send student activity reminders" to have the system automatically contact inactive students.';
$string['help_step2_heading'] = '2. Review admin settings';
$string['help_step3_body'] = 'Open the Risk Rules tab. Default rules are seeded automatically on first install. Adjust the thresholds and weights to match your institution\'s policy. Higher weights increase a student\'s risk score for that factor.';
$string['help_step3_heading'] = '3. Configure risk rules';
$string['help_step4_body'] = 'Open the Message Templates tab. Two templates are provided by default: Initial contact and Follow-up. Customise the subject and body, then use them from any intervention case via the Send Message section. Placeholders available: {firstname}, {lastname}, {course}, {adviser}.';
$string['help_step4_heading'] = '4. Customise message templates';
$string['help_step5_body'] = 'From the main dashboard or any course detail page, at-risk students are highlighted. Click "Create Intervention" to open a case, assign it to a staff member, add notes, and send messages. Monitor all cases from the Intervention Reports tab.';
$string['help_step5_heading'] = '5. Start using interventions';
$string['help_taskstatus_note'] = 'If course detail pages are slow after install, check the Task Status tab. The cache build task queues one ad-hoc task per course. These tasks must be processed by Moodle cron before snapshots are available.';
...
$string['intervention_msg_failed'] = 'Message could not be delivered. The site messaging settings may prevent staff from messaging students outside shared courses. Ask your Moodle administrator to enable "Allow messaging of all users" in Site administration → Messaging.';
...
$string['msgtemplates_body'] = 'Message body';
$string['msgtemplates_desc'] = 'Customise the message templates used when contacting students from an intervention case. Changes apply to all staff immediately.';
$string['msgtemplates_heading'] = 'Message Templates';
$string['msgtemplates_placeholders'] = 'Available placeholders — replaced with real values when sending: {firstname} {lastname} {course} {adviser}';
$string['msgtemplates_saved'] = 'Message templates saved.';
$string['msgtemplates_subject'] = 'Subject line';
$string['msgtemplates_tmpl1_heading'] = 'Template 1 — Initial Contact';
$string['msgtemplates_tmpl2_heading'] = 'Template 2 — Follow-up';
...
$string['setup_guide_heading'] = 'Setup Guide';
$string['setup_guide_intro'] = 'Follow these steps to get Course Insights configured and running on your Moodle site.';
...
$string['tab_msgtemplates'] = 'Message Templates';
$string['tab_riskrules'] = 'Risk Rules';
$string['tab_setupguide'] = 'Setup Guide';
