...
/**
 * AMD transport module for the user autocomplete on the user report page.
 *
 * @module     local_courseinsights/user_selector
...
export const transport = (selector, query, callback, failure) => {
    ajaxCall([{
        methodname: 'local_courseinsights_search_users',
        args: {query},
        done: callback,
        fail: failure,
    }]);
